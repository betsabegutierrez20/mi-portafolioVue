...
const educacion = ref([
  {fecha: '2024', title: 'Primer Semestre', descripcion: ' Comenzamos a estudiar en UTN FRRS en la tecnicatura en programac', enlace:'https://www.youtube.com/'},
  {fecha: '2024', title: 'Segundo Semestre', descripcion: 'Iniciamos el segundo semestre en la tecnicat', enlace:'http:www.direccion.com'},
  {fecha: '2025', title: 'Tercer Semestre', descripcion: 'Iniciamos el cuarto semestre con nuevas materias en desarrollo web y aplicaciones móviles ', enlace:'http:www.direccion.com'},
  {fecha: '2025', title: 'Cuarto Semestre', descripcion: 'Finalizamos la tecnicatura y nos graduamos de la ', enlace:'http:www.direccion.com'}
]);
</script>

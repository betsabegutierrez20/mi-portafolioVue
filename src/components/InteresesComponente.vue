...
const intereses = ref([
    ...
    'Tecnología: Me apasiona explorar nuevas tendencias y herramientas para la creacion del sitios webs para el mundo comercial o de ventas ',
    'Aprendizajes: Me fascina el marketing digital funcionada con la programación se vuelve interesante. ',
    'Pasatiempos: Me encanta la cocina, la reposteria y la indumentaria textil son mis pasa tiempos preferidos y sobre todo relajantes.'
]);
</script>

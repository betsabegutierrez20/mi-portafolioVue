...
<template>
    <!--Aqui va el codigo de HTML de la galeria d e proyectos-->
    <div class="galeria">
        <!--Itera sobre cada proyecto en la lista de misProyectos-->
        <!--key es una propiedad especial que se utiliza para identificar de forma única cada elemnto en una lista  deVue.js-->
...
/*.galeria{
    ...
    background-size: cover;  Que ocupe todo el espacio la imagen
    background-position: center;  este centrada la imagen
